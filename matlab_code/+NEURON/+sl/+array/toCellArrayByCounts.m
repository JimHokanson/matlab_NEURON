...
%
%   data_cell_array = NEURON.sl.array.toCellArrayByCounts(data,counts)
%
...
data   = 1:10;
counts = [2 3 5]; 
data_cell_array = NEURON.sl.array.toCellArrayByCounts(data,counts); %#ok<NASGU>
