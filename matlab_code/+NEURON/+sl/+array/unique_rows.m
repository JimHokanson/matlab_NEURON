classdef unique_rows < NEURON.sl.array.unique_super
    %
    %   Class:
    ...
    properties (Constant,Hidden)
        ...
        IS_DIFFERENT_HANDLE  = @NEURON.sl.array.unique_rows.isDifferent
        IS_2D = true
    end
    
    methods
        function obj = unique_rows(data)
            obj@NEURON.sl.array.unique_super(data);
        end
    end
    ...
    methods (Hidden,Static)
        ...
        function hidden_test_function()
            temp = NEURON.sl.array.unique_rows(randi(10,10000,3));
            keyboard
        end
    end
end
