classdef enforce_minimum_counts_by_regrouping < NEURON.sl.obj.handle_light
    %
    %   Class:
    %   NEURON.sl.array.enforce_minimum_counts_by_regrouping
    %
    %   wtf = NEURON.sl.array.enforce_minimum_counts_by_regrouping(5:15,20)
    %
