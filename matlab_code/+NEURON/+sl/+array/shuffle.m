...
%
%
%   data_out = NEURON.sl.array.shuffle(data_in,varargin);
%
...
r = reshape(1:25,5,5);
data_out_1  = NEURON.sl.array.shuffle(r);       %#ok<NASGU>
data_out0 = NEURON.sl.array.shuffle(r,'dim',0); %#ok<NASGU>
data_out1 = NEURON.sl.array.shuffle(r,'dim',1); %#ok<NASGU>
data_out2 = NEURON.sl.array.shuffle(r,'dim',2); %#ok<NASGU>
...
tic
for i = 1:100
data_out0 = NEURON.sl.array.shuffle(r,'dim',0,'use_fyd',false); %#ok<NASGU>
end
toc
