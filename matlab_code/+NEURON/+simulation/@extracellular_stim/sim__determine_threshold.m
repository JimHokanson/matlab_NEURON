function [thresh_value,nLoops] = sim__determine_threshold(obj,starting_value)
...
%   IMPROVEMENTS
%   =======================================================
%   1) DONE Allow only a single sided solution ...
%
%   
%   TODO: threshold_cmd needs to be rewritten
%
%
%
...
%DAMN CORNER CASES
%=============================================
%1) A strong cathodal stimulus will cause inactivation on the sides
%   - somehow I need to handle this ...
%
%   Example
%   : - in center of 400 um spaced electrodes
%   : - test stims -1, -2 then -25, no, no, then activation at center but blocking



%NOTE: All of this should move to a class ...
%perhaps this just interfaces with the threshold object ?????

%TODO: Need options on what to do in cases of not finding single valued 
