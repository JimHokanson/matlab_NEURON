...
%
%   See also:
%       NEURON.cell.axon.generic_unmyelinated.spatial_info.populate_spatialInfo

n_segs = obj.props_obj.n_segs;

if size(obj.xyz_all,1) ~= n_segs;
    obj.xyz_all = zeros(n_segs,3);
end
...
%Make center at zero, then offset everything to the center location ...
