classdef props < handle
    ...
    properties   
        ...
        %NOTE: In general it is desirable to make this even ...
        %NOTE: This parameter is CRUCIAL in terms of execution time
        n_segs   = 20     %A bit misleading, need a better name 
        
		%electrical parameters -----------------------------
        
        %NOTE: Careful about changing this since the model dynamics impose this ...
    ...
    methods
        ...
        function populateExtracellularParameters(obj)
           ...
           obj.xg_1 = obj.g_myelin/(obj.number_lemella*2); %Is the x2 correct????
           obj.xg_2 = obj.xg_1;
           obj.xg_i = obj.xg_1;
